...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 556, ; uint32_t number_of_dso_cache_entries (0x22c)
	i32 33555214, ; uint32_t android_runtime_jnienv_class_token (0x200030e)
	i32 100671742, ; uint32_t jnienv_initialize_method_token (0x60020fe)
	i32 100671741, ; uint32_t jnienv_registerjninatives_method_token (0x60020fd)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [556 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.90_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 31
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2374722256649126529, ; hash 0x20f4b54f83c90281, from name: aot-SpookySeason
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 61
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-SkiaSharp.Views.Maui.Controls.dll.so
		ptr null; void* handle (0x0)
	}, ; 96
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-SkiaSharp.Views.Maui.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 116
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6658527326745179490, ; hash 0x5c67d75345e0b562, from name: aot-SpookySeason.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 170
	...
	%struct.DSOCacheEntry {
		i64 6818264025115825344, ; hash 0x5e9f570191da94c0, from name: libaot-SpookySeason
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 177
	...
	%struct.DSOCacheEntry {
		i64 8928725087120744866, ; hash 0x7be934290af361a2, from name: SpookySeason.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 257
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.24_name, ; name: libaot-SkiaSharp.Views.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 259
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 14002684116806916357, ; hash 0xc2538703cc47d905, from name: libaot-SpookySeason.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 423
	...
	%struct.DSOCacheEntry {
		i64 16321320609835082458, ; hash 0xe280fa9ede7b62da, from name: SpookySeason
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 492
...
@.env.3 = private unnamed_addr constant [37 x i8] c"d05cb286-6ee6-4c60-bc93-b3184623090f\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.TaKusa.spookyseason\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [27 x i8] c"libaot-SpookySeason.dll.so\00", align 16
...
@.DSOCacheEntry.23_name = private unnamed_addr constant [24 x i8] c"libaot-SkiaSharp.dll.so\00", align 16
@.DSOCacheEntry.24_name = private unnamed_addr constant [38 x i8] c"libaot-SkiaSharp.Views.Android.dll.so\00", align 16
@.DSOCacheEntry.25_name = private unnamed_addr constant [44 x i8] c"libaot-SkiaSharp.Views.Maui.Controls.dll.so\00", align 16
@.DSOCacheEntry.26_name = private unnamed_addr constant [40 x i8] c"libaot-SkiaSharp.Views.Maui.Core.dll.so\00", align 16
...
@.DSOCacheEntry.90_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
