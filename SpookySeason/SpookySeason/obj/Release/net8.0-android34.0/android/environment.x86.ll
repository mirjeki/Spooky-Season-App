...
@dso_cache = dso_local local_unnamed_addr global [556 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 321810143, ; hash 0x132e6edf, from name: SpookySeason.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1694977098, ; hash 0x65074c4a, from name: SpookySeason
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 208
	...
	%struct.DSOCacheEntry {
		i64 1922614932, ; hash 0x7298c694, from name: aot-SpookySeason.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 239
	...
	%struct.DSOCacheEntry {
		i64 2098891590, ; hash 0x7d1a8b46, from name: aot-SpookySeason
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 265
	...
	%struct.DSOCacheEntry {
		i64 2218531806, ; hash 0x843c1bde, from name: libaot-SpookySeason.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 284
	...
	%struct.DSOCacheEntry {
		i64 3992604093, ; hash 0xedfa4dbd, from name: libaot-SpookySeason
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SpookySeason.dll.so
		ptr null; void* handle (0x0)
	}, ; 517
